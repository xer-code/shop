<?php $pageTitle = 'Create Account — ShopX Global'; ?>
<div class="auth-container fade-in">
    <div class="auth-card">
        <p style="text-align: center; margin-bottom: 0.5rem;">
            <a href="<?= url('/login') ?>" style="color: var(--text-muted); font-size: 0.9rem;">← Back to sign in</a>
        </p>
        ...
        <form method="POST" action="<?= url('/register') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="input-dark" placeholder="John Doe" value="<?= old('name') ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <input type="password" name="password" class="input-dark" placeholder="Min. 8 characters" style="padding-left: 2.5rem;" required minlength="8">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <svg style="position: absolute; left: 0.75rem; top: 50%; transform: translateY(-50%); color: var(--text-muted);" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
                    <input type="password" name="password_confirmation" class="input-dark" placeholder="Re-enter password" style="padding-left: 2.5rem;" required>
                </div>
            </div>
            
            <button type="submit" class="btn-gold" style="width: 100%; justify-content: center; margin-top: 0.5rem; background: linear-gradient(135deg, #1e293b, #334155); color: white;">
                Create account
            </button>
        </form>
    </div>
